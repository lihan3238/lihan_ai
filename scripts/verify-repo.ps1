...
Assert-File "docs/maintainer-release-runbook.md"
Assert-File "docs/zh-CN/maintainer-release-runbook.md"
Assert-File "docs/user-quickstart.md"
Assert-File "docs/user-guide.md"
Assert-File "docs/zh-CN/user-quickstart.md"
Assert-File "docs/zh-CN/user-guide.md"
...
Assert-File "ops/relayctl.sh"
Assert-File "ops/release-readiness.sh"
...
Assert-File "tests/formal-release.test.sh"
...
Assert-File "vendor/cli-proxy-api/docker-compose.yml"
...
Assert-Contains "README.md" "Production backup details" "README backup section"
...
Assert-Contains "README.md" "ops/relayctl\.sh" "README formal operations guidance"
Assert-Contains "README.md" "E2E Coverage Matrix" "README E2E matrix guidance"
Assert-Contains "README.md" "docs/user-quickstart\.md" "README user quickstart guidance"
Assert-Contains "README.md" "CONTRIBUTING\.md" "README contribution guidance"
Assert-Contains "README.md" "new-api-small-circle-launch-runbook\.md" "README small circle launch runbook"
Assert-Contains "README.md" "vendor/cli-proxy-api" "README CLIProxyAPI submodule guidance"
Assert-Contains "README.md" "GitHub Actions PR CI" "README CI guidance"
...
Assert-Contains "README.zh-CN.md" "ops/relayctl\.sh" "Chinese README formal operations guidance"
Assert-Contains "README.zh-CN.md" "E2E Coverage Matrix" "Chinese README E2E matrix guidance"
Assert-Contains "README.zh-CN.md" "docs/zh-CN/user-quickstart\.md" "Chinese README user quickstart guidance"
Assert-Contains "README.zh-CN.md" "CONTRIBUTING\.md" "Chinese README contribution guidance"
Assert-Contains "README.zh-CN.md" "new-api-small-circle-launch-runbook\.md" "Chinese README small circle launch runbook"
Assert-Contains "README.zh-CN.md" "vendor/cli-proxy-api" "Chinese README CLIProxyAPI submodule guidance"
Assert-Contains "README.zh-CN.md" "GitHub Actions PR CI" "Chinese README CI guidance"
...
Assert-Contains ".github/pull_request_template.md" "Community PR boundary" "PR community boundary"
...
Assert-Contains "ops/production-gate.sh" "tests/formal-release.test.sh" "formal release gate test"
...
Assert-Contains "ops/pre-commit.sh" "formal-release\.test\.sh" "pre-commit formal release test"
Assert-Contains "ops/relayctl.sh" "deploy-prepare" "formal operations deploy prepare"
Assert-Contains "ops/relayctl.sh" "release-check" "formal operations release check"
Assert-Contains "ops/release-readiness.sh" "tracked runtime artifact scan" "release readiness runtime artifact scan"
Assert-Contains "ops/release-readiness.sh" "sensitive pattern scan" "release readiness sensitive scan"
Assert-Contains "docs/maintainer-release-runbook.md" "ops/relayctl\.sh" "maintainer release wrapper docs"
Assert-Contains "docs/user-quickstart.md" "https://api\.lihan3238\.com/v1" "user quickstart API base URL"
Assert-Contains "docs/user-guide.md" "OpenAI-compatible" "user guide client guidance"
Assert-Contains "CONTRIBUTING.md" "Community PR Boundary" "contribution PR boundary"
Assert-Contains "SECURITY.md" "Do not open public issues for secrets" "security private reporting"
...
Assert-Contains ".gitignore" "docs/ai-dev/" "local AI working notes ignored"
