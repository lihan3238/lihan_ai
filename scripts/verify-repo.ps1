...
Assert-Contains ".github/workflows/cd.yml" "PROD_DEPLOY_HOST" "CD deploy host secret"
Assert-Contains ".github/workflows/cd.yml" "deploy-release\.sh prepare" "CD prepares release"
Assert-Contains ".github/workflows/cd.yml" "deploy-release\.sh smoke" "CD smokes release"
Assert-Contains ".github/workflows/cd.yml" "workflow_dispatch" "CD manual production command"
