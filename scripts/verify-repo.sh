...
assert_contains "docker-compose.cpa.ui.yml" "10.22.0.40" "CPA UI WireGuard bind"
...
assert_contains "docs/cloudflare-saas-runbook.md" "172.64.155.231" "Cloudflare preferred IP guidance"
assert_contains "docs/cloudflare-saas-runbook.md" "blog.lihan3238.com" "Cloudflare blog hostname boundary"
assert_contains "docs/cloudflare-saas-runbook.md" "http_status:404" "Cloudflare Tunnel safe catch-all"
...
assert_contains "docs/cpa-runbook.md" "10.22.0.40:8317" "CPA WireGuard UI URL"
