...
assert_contains "ops/local-new-api-e2e.sh" "LOCAL_E2E_REDIS_CONTAINER"
assert_contains "ops/local-new-api-e2e.sh" "rateLimit:*"
assert_contains "ops/local-new-api-e2e.sh" "redis-cli"
