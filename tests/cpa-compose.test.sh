...
assert_not_contains "docker-compose.cpa.yml" "cpa-quota-static"
assert_not_contains "docker-compose.cpa.yml" "relay-cpa-quota-static"
assert_not_contains "docker-compose.cpa.yml" "Caddyfile.cpa-quota"
assert_not_contains "docker-compose.cpa.yml" "public/cpa-quota"
assert_not_contains "docker-compose.cpa.yml" "CPA_PUBLIC_PATH"
...
assert_not_contains "Caddyfile" "handle_path /cpa-quota/*"
assert_not_contains "Caddyfile" "cpa-quota-static:8080"

assert_contains "docker-compose.cpa.ui.yml" "10.22.0.40:"
assert_contains "docker-compose.cpa.ui.yml" "CPA_UI_PORT"

assert_contains "docs/cpa-runbook.md" "10.22.0.40:8317"
...
assert_not_contains "docs/cpa-runbook.md" "ops/cpa-quota-snapshot.sh"
assert_not_contains "docs/cpa-runbook.md" "cpa-quota/widget.html"
assert_not_contains "docs/cpa-runbook.md" "cpa-quota-static"
...
assert_contains "docs/zh-CN/cpa-runbook.md" "10.22.0.40:8317"
...
assert_not_contains "docs/zh-CN/cpa-runbook.md" "ops/cpa-quota-snapshot.sh"
assert_not_contains "docs/zh-CN/cpa-runbook.md" "cpa-quota/widget.html"
assert_not_contains "docs/zh-CN/cpa-runbook.md" "cpa-quota-static"
