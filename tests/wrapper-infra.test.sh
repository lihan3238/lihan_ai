...
assert_file "scripts/verify-repo.sh"
assert_not_file "scripts/verify-repo.ps1"
...
assert_executable "tests/formal-release.test.sh"
...
assert_file "docs/zh-CN/maintainer-release-runbook.md"
...
assert_contains "ops/export-config-snapshot.sh" "convert_to(key, 'UTF8')"
assert_contains "ops/export-config-snapshot.sh" "convert_to(value, 'UTF8')"
assert_not_contains "ops/export-config-snapshot.sh" "::bytea"
...
assert_contains "docker-compose.cpa.ui.yml" "10.22.0.40"
...
assert_contains "ops/relayctl.sh" "deploy-prepare"
assert_contains "ops/relayctl.sh" "release-check"
assert_contains "ops/release-readiness.sh" "tracked runtime artifact scan"
assert_contains "ops/release-readiness.sh" "sensitive pattern scan"
...
assert_contains "docs/maintainer-release-runbook.md" "ops/relayctl.sh"
assert_contains "docs/maintainer-release-runbook.md" "release-check"
assert_contains "docs/user-quickstart.md" "https://api.lihan3238.com/v1"
assert_contains "docs/user-guide.md" "OpenAI-compatible"
assert_contains "CONTRIBUTING.md" "Community PR Boundary"
...
assert_contains ".github/workflows/ci.yml" "scripts/verify-repo.sh --skip-docker"
assert_not_contains ".github/workflows/ci.yml" "verify-repo.ps1"
assert_not_contains ".github/workflows/ci.yml" "pwsh"
