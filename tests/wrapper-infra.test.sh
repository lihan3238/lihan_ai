...
assert_executable "ops/production-monitor.sh"
...
assert_executable "tests/production-monitor.test.sh"
assert_executable "tests/ops-health-report.test.sh"
assert_executable "tests/kuma-ui-script.test.sh"
assert_executable "tests/ops-dashboard.test.sh"
...
assert_contains ".env.production.example" "MONITOR_ALERT_WEBHOOK_URL="
assert_contains ".env.production.example" "MONITOR_PUSH_AUDIT_URL="
assert_contains ".env.production.example" "OPS_DASHBOARD_PORT=3021"
...
assert_contains "docker-compose.ops-dashboard.yml" "logs/ops-health"
...
assert_contains "ops/production-gate.sh" "tests/production-monitor.test.sh"
assert_contains "ops/production-gate.sh" "tests/ops-health-report.test.sh"
assert_contains "ops/production-gate.sh" "tests/kuma-ui-script.test.sh"
assert_contains "ops/production-gate.sh" "tests/ops-dashboard.test.sh"
...
assert_contains "docs/kuma-status-runbook.md" "MONITOR_PUSH_AUDIT_URL"
assert_contains "docs/kuma-status-runbook.md" "ops/kuma-ui.sh open"
assert_contains "docs/kuma-status-runbook.md" "ssh -L 3011:127.0.0.1:3011"
assert_contains "docs/kuma-status-runbook.md" "Ops Dashboard"
...
assert_contains "ops/production-monitor.sh" "MONITOR_ALERT_WEBHOOK_URL"
assert_contains "ops/production-monitor.sh" "MONITOR_PUSH_RESTORE_DRILL_URL"
assert_contains "ops/production-monitor.sh" "production-monitor-"
assert_contains "ops/ops-health-report.sh" "status.json"
...
assert_contains "docs/ops-quick-reference.md" "cronie"
assert_contains "docs/ops-quick-reference.md" "ops/deploy-release.sh promote"
assert_contains "docs/ops-quick-reference.md" "restic snapshots"
assert_contains "docs/ops-quick-reference.md" "restore-postgres.sh"
assert_contains "docs/zh-CN/ops-quick-reference.md" "cronie"
assert_contains "docs/zh-CN/ops-quick-reference.md" "ops/deploy-release.sh promote"
assert_contains "docs/zh-CN/ops-quick-reference.md" "restic snapshots"
