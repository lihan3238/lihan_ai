...
assert_contains "e2e/new-api-admin-users.spec.ts" "NEW_API_REQUIRE_ADMIN_E2E"
assert_contains "e2e/new-api-admin-users.spec.ts" "verifyUserMenuDialog"
assert_contains "e2e/new-api-admin-users.spec.ts" "toBeVisible({ timeout"
...
assert_contains "e2e/new-api-admin-users.spec.ts" "waitForTimeout(250)"
...
assert_contains "docs/browser-e2e-runbook.md" "ops/local-new-api-e2e.sh"
