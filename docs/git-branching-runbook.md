...
- Keep feature working notes under local ignored `docs/ai-dev/<YYYY-MM-DD>-<topic>/` when useful, and copy durable decisions, verification, and residual risk into the PR description or maintained runbooks.
